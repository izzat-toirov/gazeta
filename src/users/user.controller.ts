...
export class UserController {
  ...
  @ApiResponse({ status: 201, description: 'The user has been successfully created.', type: Object })
  ...
  @ApiResponse({ status: 200, description: 'The user has been successfully updated.', type: Object })
  @ApiResponse({ status: 400, description: 'Bad Request - Validation error or foreign key constraint violation' })
  @ApiResponse({ status: 401, description: 'Unauthorized - Token missing or invalid' })
  @ApiResponse({ status: 403, description: 'Forbidden - Insufficient permissions' })
  @ApiResponse({ status: 404, description: 'Not Found - User does not exist' })
  ...
  @ApiResponse({ status: 200, description: 'The user has been successfully deleted.', type: Object })
  @ApiResponse({ status: 400, description: 'Bad Request - Invalid ID format' })
  @ApiResponse({ status: 401, description: 'Unauthorized - Token missing or invalid' })
  @ApiResponse({ status: 403, description: 'Forbidden - Insufficient permissions' })
  @ApiResponse({ status: 404, description: 'Not Found - User does not exist' })
